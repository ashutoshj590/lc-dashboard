 ...
 */
 ...
 /**
  * @apiDefine SessionExpiredError
  * @apiErrorExample Error-Response:
  *  HTTP/1.1 405 Error
  *     {
  *       "status": "UserNotFound"
  *       "response_code": 405
  *       "response_message": "Server is unable to fetch user id, session has expired. Please call api/adduser"
  *     }
  */

exports.RESPONSE_SUCCESS = {text :  "success", code:200};
exports.RESPONSE_SESSION_EXPIRED = {text :  "session_expired", code:405};
exports.RESPONSE_ERROR = {text :  "error", code:401};
